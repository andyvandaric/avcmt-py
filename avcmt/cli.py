...
if not os.getenv("POLLINATIONS_API_KEY"):
    print("Error: POLLINATIONS_API_KEY is not set! Please create a .env file in the project root or set the environment variable.")
    exit(1)
...
def main():
    ...
    parser.add_argument(
        ...
        help="Push all commits to remote after finishing"
    )
    parser.add_argument(
